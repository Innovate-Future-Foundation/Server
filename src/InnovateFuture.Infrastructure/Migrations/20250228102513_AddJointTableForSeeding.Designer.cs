...
namespace InnovateFuture.Infrastructure.Migrations
{
    ...
    [Migration("20250228102513_AddJointTableForSeeding")]
    partial class AddJointTableForSeeding
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InnovateFuture.Domain.Entities.ActivityDay", b =>
                {
                    ...
                    b.HasKey("DaysBelongId", "ActivitiesId");
            ...
            modelBuilder.Entity("InnovateFuture.Domain.Entities.ActivityProfile", b =>
                {
            ...
            modelBuilder.Entity("InnovateFuture.Domain.Entities.ActivityDay", b =>
                {
                    b.HasOne("InnovateFuture.Domain.Entities.Activity", "Activity")
                        .WithMany("DaysBelong")
            ...
            modelBuilder.Entity("InnovateFuture.Domain.Entities.ActivityProfile", b =>
                {
                    b.HasOne("InnovateFuture.Domain.Entities.Activity", "Activity")
                        .WithMany("TeachersAssigned")
                        .HasForeignKey("AssignedActivitiesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("InnovateFuture.Domain.Entities.Profile", "Teacher")
            ...
            modelBuilder.Entity("InnovateFuture.Domain.Entities.Activity", b =>
                {
                    b.Navigation("DaysBelong");

                    b.Navigation("TeachersAssigned");
                });
