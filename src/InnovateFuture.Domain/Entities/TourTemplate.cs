...
public class TourTemplate
{
    ...
    public ICollection<DayTemplate>? DayTemplates { get; private set; } = new List<DayTemplate>(); 
    ...
    // Add DayTemplate 
    public void AddDayTemplate(DayTemplate dayTemplate)
    {
        if (dayTemplate == null)
        {
            throw new ArgumentNullException(nameof(dayTemplate), "DayTemplate cannot be null.");
        }
